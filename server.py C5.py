...
def trigger_endpoint(req: TriggerRequest):
    """Trigger an event from a device (ESP32, tablet, etc.)."""
    ...
    evt = trigger(button=req.button, language=req.language, source="DEVICE", custom_text=req.custom_text, device_id=req.device_id, user_id=req.user_id)
